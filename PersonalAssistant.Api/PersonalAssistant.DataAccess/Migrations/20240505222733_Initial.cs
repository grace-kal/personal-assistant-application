        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeatherKind = table.Column<int>(type: "int", nullable: false),
                    ClothKind = table.Column<int>(type: "int", nullable: false),
                    ClothArea = table.Column<int>(type: "int", nullable: false),
                    ClothLenght = table.Column<int>(type: "int", nullable: false),
                    ClothThickness = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClothOutfit", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClothOutfit_Clothes_ClothId",
                        column: x => x.ClothId,
                        principalTable: "Clothes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClothOutfit_Outfits_OutfitId",
                        column: x => x.OutfitId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClothOutfit_ClothId",
                table: "ClothOutfit",
                column: "ClothId");

            migrationBuilder.CreateIndex(
                name: "IX_ClothOutfit_OutfitId",
                table: "ClothOutfit",
                column: "OutfitId");
